...
describe SpreeGoogleBase::FeedBuilder do
  ...
  describe 'as class' do
    context '#builders should return an array for each store' do
      ...
      Factory :store, :url => 'www.mystore.com', :code => 'first', :name => 'Goodies, LLC'
      Factory :store, :url => 'www.anotherstore.com', :code => 'second', :name => 'Gifts, LLC'
  ...
  describe 'as instance' do
    ...
    describe 'w/ store defined' do
      before(:each) do
        @store = Factory :store, :url => 'www.mystore.com', :code => 'first', :name => 'Goodies, LLC'
        @store2 = Factory :store, :url => 'www.anotherstore.com', :code => 'second', :name => 'Gifts, LLC'
      ...
      it "should initialize with the correct domain" do
        @builder.domain.should == @store.url.match(/[\w\.]+/).to_s
      end
